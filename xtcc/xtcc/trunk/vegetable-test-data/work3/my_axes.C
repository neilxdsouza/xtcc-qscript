...
axis_q1::axis_q1(int32_t & p_q1_data, const char * p_text_ttls[])
:ttl_stmt_text (), count_stmt_text (3), axis_stmt_type_print (), axis_stmt_type_count (3) 
, q1_data (p_q1_data){
...
axis_q2::axis_q2(int32_t (& p_q2_arr) [6], const char * p_text_ttls[])
...
AxesGroup::AxesGroup(): 
	 ax_q1(q1_data, q1_ttl_stmt_arr),
	 ax_q2(q2_arr, q2_ttl_stmt_arr),
